...
function App() {
  ...
  return (
    ...
    <Menu />
    <div className='pl-7 pr-5  max-lg:pl-4 max-lg:pr-4 max-sm:pl-4 max-sm:pr-4  xl:pl-48 xl:pr-48'>
          <hr className='border-t-2 border-[#2B2B2B]' />
          
    </div>
    <Cuerpo />
    <div className='grid grid-cols-4 pb-6 pt-6 pl-7 pr-5 gap-5 max-lg:grid-cols-4 max-sm:grid-cols-2 xl:ml-40 xl:mr-40 max-sm:pl-4 max-sm:pr-4'>
